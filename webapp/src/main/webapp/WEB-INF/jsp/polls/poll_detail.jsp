                                ...
                                <div class="row align-items-end" style="margin: 10px 10px 10px;">
                                    ...
                                    <span class="text-xs">
                                        <c:if test="${poll.submittedBy != null}">
                                            <c:url value="/profile/${poll.submittedBy.id}" var="url"/>
                                            <a href="${url}">
                                                <spring:message code="publishedBy"
                                                    arguments="${poll.submittedBy.name}, ${creationFormat.format(poll.creationDate)}"/>
                                            </a>
                                        </c:if>
                                        <c:if test="${poll.submittedBy == null}">
                                                    ...
                                                    <c:forEach var="vote" items="${votes}">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row align-items-center no-gutters">
                                                                <div class="col mr-2">
                                                                    <h6 class="mb-0">
                                                                        <strong><c:out value="${vote.key.value}"/></strong>
                                                                    </h6>
                                                                    <span>
