            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-auto custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="showHiddenSwitch" ${showSeen ? 'checked' : ''}>
                            <label class="custom-control-label" for="showHiddenSwitch">
                                <spring:message code="announcement.seeHidden"/>
                            </label>
                        </div>
                        ...
                        <div class="col col-md-auto">
                            <form action="<c:url value="/announcements/seen"/>" method="post">
                                <button type="submit" class="btn btn-primary btn-sm">
                                    <i class="material-icons pull-left">done</i>
                                    <spring:message code="announcement.checkAllAsSeen"/>
                                </button>
                            </form>
                        </div>
                    </div>
