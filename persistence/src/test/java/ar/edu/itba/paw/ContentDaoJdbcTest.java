...
public class ContentDaoJdbcTest {
    ...
    public void findContentTest() {
        List<Content> contentList = contentDao.findContent("1.1", Content.ContentType.miscellaneous,null,null,0,1000);
    ...
    public void deleteTest(){
        List<Content> contentList = contentDao.findContent("1.1", Content.ContentType.miscellaneous,null,null,0,10);
        Assert.assertEquals(2,contentList.size());
        Assert.assertEquals(1,contentList.get(0).getId());
        Assert.assertEquals(2,contentList.get(1).getId());
        ...
        contentList = contentDao.findContent("1.1",Content.ContentType.miscellaneous,null,null,0,10);
    ...
    public void createContentTest(){
        ...
        Assert.assertTrue(contentDao.createContent("name", "www.test.com", "1.1", "test description", "miscellaneous", null,
