create sequence announcement_id_seq START WITH 1;

create sequence career_id_seq START WITH 1;

create sequence poll_id_seq START WITH 1;

create sequence poll_option_id_seq START WITH 1;
...
(
    ...
    name          text                                            not null,
    description   text,
    format        text     default 'multiple-choice'                 not null   check (format in ('multiple-choice', 'text')),
    course_id     text,
