...
INSERT INTO course(id,name) VALUES ('1.1', 'Course 1'); -- Will have 1 contribution
INSERT INTO course(id,name) VALUES ('1.2', 'Course 2'); -- Will have 2 contributions
INSERT INTO course(id,name) VALUES ('1.3', 'Course 3'); -- Will have 3 contributions

INSERT INTO users(id,name,surname,email,career_code,verified) VALUES (1, 'User 1', 'Surname', 'usr1@test.com', 'A', true); -- Will have 2 contributions
INSERT INTO users(id,name,surname,email,career_code,verified) VALUES (2, 'User 2', 'Surname', 'usr2@test.com', 'A', true); -- Will have 4 contributions
INSERT INTO users(id,name,surname,email,career_code,verified) VALUES (3, 'User 3', 'Surname', 'usr3@test.com', 'A', true); -- Will have 6 contributions
